...
<?php 
    $l_sql="select a.* from tblDMKhu a, tblNVTrucKhu b Where a.MaKhu = b.MaKhu and a.MaKhu in (Select MaKhu from tblDMBan Group by MaKhu) and b.MaNhanVien like '$manv' and a.IsDieuTour = 1 Order by a.MaKhu";
    $makhu = "";
